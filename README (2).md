...
4. Configure a autenticação da OpenAI API.

5. Configure o serviço de envio de e-mail.

6. Revise as variáveis utilizadas nos nodes.

7. Ative o workflow.

8. Envie uma review para o bot no Telegram.

9. Confira a análise recebida no Telegram e no e-mail.
